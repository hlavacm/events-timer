<template>
  <div id="app">
      <section id="hero-section" class="hero is-fullheight is-dark is-bold">
        <div class="hero-head">
...
export default {
  ...
  methods: {
    ...
    showCreditsPopup: function () {
      this.$refs.creditsPopup.isActive = true
    }
  }
}
</script>
