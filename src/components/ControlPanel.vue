      ...
      <div class="navbar-end">
        ...
        <div class="navbar-item">
          <div class="field is-grouped">
            <p class="control">
              <control-button title="Settings" colorClass="is-link" @clicked="$refs.settingsPopup.isActive = true">
            ...
            <p class="control">
              <control-button title="Credits" colorClass="is-info" @clicked="$refs.creditsPopup.isActive = true">
